...
根据`jawr.properties`的位置，参考 jawr Java 的路径解释部分实现，生成了一个中间文件夹 ![generated-indexes folder](./karma-jawr-generated-index.png) 配合 webpack 的`alias`功能，我们只要在单元测试代码里面使用类似这样的语法
